                  ...
                  <CardContent className="p-6 space-y-6">
                    ...
                    <div>
                      ...
                      <div className="text-slate-300 space-y-3">
                        <p>
                          L'ensemble de ce site web, y compris les textes,
                          images, codes sources, et design, est la propriété
                          exclusive de Kevine, sauf mention contraire.
                        </p>
                        <p>
                          ...
                          l'accord écrit de Kevine.
                        </p>
                        <p>
                          Les marques et logos mentionnés sur ce site
                    ...
                    <div>
                      ...
                      <div className="text-slate-300 space-y-3">
                        <p>
                          ...
                          précises que possible et le site est périodiquement
                          remis à jour, mais peut toutefois contenir des
                          inexactitudes, des omissions ou des lacunes.
                        </p>
                        <p>
                          Kevine ne pourra en aucun cas être tenu responsable de
                          tout dommage de quelque nature que ce soit résultant
                          de l'interprétation ou de l'utilisation des
                    ...
                    <div>
                      ...
                      <div className="text-slate-300 space-y-3">
                        <p>
                          Ce site peut collecter des données anonymes de
                          navigation à des fins d'amélioration de l'expérience
                          utilisateur via Google Analytics.
                        </p>
                        <p>
                          Pour plus d'informations sur la collecte et
                          l'utilisation des données, consultez notre{" "}
                          <Link
                    ...
                    <div>
                      ...
                      <div className="text-slate-300 space-y-3">
                        <p>
                          Le présent site web et les présentes mentions légales
                          sont régis par le droit français. En cas de litige,
